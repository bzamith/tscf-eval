...
def sample_params(param_dist, n_iter, random_state=42):
    """
...
def hpo_random_search(
    ...
    classifier_class : class
        Classifier class to instantiate.
    param_dist : dict
        Dictionary mapping parameter names to lists of possible values.
    X_train : array-like
        Training features.
...
def save_models(models, hpo_results, model_types, dataset_names, output_dir="trained_models"):
    """
...
def load_models(model_types, dataset_names, models_dir="trained_models"):
    """
