...
If you already have counterfactuals generated by any method:
...
# Your data
X = np.random.randn(10, 100)       # 10 original instances
X_cf = X + np.random.randn(10, 100) * 0.1  # Your counterfactuals
...
analyzer.plot_front(results, x_metric="validity", y_metric="proximity_linf")
```
